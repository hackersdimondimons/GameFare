      ...
      <div className="min-h-screen bg-black">
        ...
        <div className="flex flex-col justify-center items-center mt-20">
          <div className=" flex flex-col items-center justify-center my-5">
            <h1 className="text-2xl font-bold text-white py-5">Create Jackpots</h1>
            <p className="text-center text-sm text-white">
              Design Your Own Lottery: Where Every Draw is Fair and Exciting! <br />
              Customize Your Lottery Experience with Prizes and Seamless Community Interaction.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-md">
            ...
            <div className="flex justify-center">
              <button
                className="w-full bg-amber-600 hover:bg-[#1a396c] text-white font-bold
