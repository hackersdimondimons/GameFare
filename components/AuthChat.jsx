    ...
    >
      <div className="bg-white shadow-lg shadow-slate-900 rounded-xl w-11/12  md:w-2/5 p-6  relative">
        ...
        <div className="flex items-center justify-center space-x-4">
          <button
            className="p-2 bg-amber-400 rounded-md text-white focus:outline-none focus:ring-0"
            onClick={handleLogin}
          >
            Login
          </button>
          <button
            className="p-2 bg-blue-600 rounded-md text-white focus:outline-none focus:ring-0"
