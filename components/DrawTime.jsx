          ...
          {wallet?.toLowerCase() == jackpot?.owner ? (
            <>
              <button
                ...
                onClick={onGenerate}
                className={`flex flex-nowrap border py-2 px-4 rounded-full bg-amber-400
                hover:bg-rose-500 font-semibold
                ${
              ...
              {!group ? (
                <button
                  ...
                  className="flex flex-nowrap border py-2 px-4 rounded-full bg-pink-500
